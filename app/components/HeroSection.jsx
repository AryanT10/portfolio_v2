  ...
  return (
    <section className="relative overflow-hidden lg:py-16">
      ...
      <div className="absolute inset-0 flex justify-center items-center z-0 overflow-hidden">
        {/* Top Left Blob */}
        <div
          className="absolute w-32 h-32 bg-purple-500 rounded-full opacity-30 blur-2xl animate-float-slow"
          style={{ top: "10%", left: "10%" }}
        />
        {/* Bottom Right Blob */}
        <div
          className="absolute w-40 h-40 bg-pink-500 rounded-full opacity-20 blur-2xl animate-float-slower"
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-12 z-10">
        ...
        <div className="col-span-8 lg:col-span-6 place-self-center text-center sm:text-left justify-self-start">
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            A dedicated programmer and enthusiast. I primarily work with
            JavaScript and am actively engaged in learning the intricacies of
            web development.
          </p>
